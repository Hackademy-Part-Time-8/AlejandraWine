  ...
  <div class="mb-3">
    ...
    <div class="mb-3">
        <label for="price" class="form-label">Price</label>
          <input class="form-control" id="price" name="price" value= "{{old('price')}}" aria-describedby="priceHelp">
          <div id="pricelHelp" class="form-text">What is the price?</div>
        </div>
        <div class="mb-3">
            <label for="vol" class="form-label">Vol</label>
              <input class="form-control" id="vol" name="vol" value= "{{old('vol')}}" aria-describedby="volHelp">
